  ...
  return (
    <div className="bg-gradient-to-r from-blue-100 to-blue-200 min-h-screen">
      ...
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <Link to="/get-started" className="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800">Get started</Link>
      </header>
      ...
      <main className="container mx-auto px-4 py-16 text-center">
        ...
        <Link to="/try-now" className="bg-blue-600 text-white px-8 py-3 rounded-md text-lg hover:bg-blue-700">Try Gauge Your Idea now</Link>
